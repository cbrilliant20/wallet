...
function FAQ() {
  return (
    <>
      ...
      <div class="container">
        <div class="sm:w-3/4 lg:w-6/12 mx-auto px-2">
        ...
        <div class="flex flex-col sm:w-3/4 lg:w-5/12 mt-12 mx-auto">
          <div class="flex items-center  border-b border-gray-500 py-4">
            ...
            <FontAwesomeIcon icon={faChevronDown} class="w-5 text-indigo-500" />
          </div>

          <div class="flex items-center  border-b border-gray-500 py-4">
            <span class="flex-1 ">Lorem ipsum dolor sit amet consectetur?</span>
            <FontAwesomeIcon icon={faChevronDown} class="w-5 text-indigo-500" />
          </div>
